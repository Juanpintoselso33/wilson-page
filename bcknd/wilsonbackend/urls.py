...
urlpatterns = [
    ...
    path('media-files/<int:media_file_id>/', get_media_file_by_id_view, name='get_media_file_by_id'),
    ...
    path('media-files/create/', create_media_file_view, name='create_media_file'),
